...
plt.title('Current leisure activities')
...
plt.title('Hope leisure activities')
plt.legend(labels=['weekday','weekend'])
...
plt.suptitle('Current leisure activities(weekday) by Cluster(1,7)')
plt.show()
...
axes[1,2].set_title("Cluster 5")
axes[2,0].set_title("Cluster 6")
plt.suptitle('Current leisure activities(weekend) by Cluster(1,7)')
plt.show()

#클러스터별 희망평일여가활동
cluster_wkd = data['HLwkd1'].groupby(data['cluster'])
...
axes[1,2].set_title("Cluster 5")
axes[2,0].set_title("Cluster 6")
plt.suptitle('Hope leisure activities(weekday) by Cluster(1,7)')
plt.show()



#클러스터별 희망주말여가활동   
cluster_wke = data['HLwke1'].groupby(data['cluster'])
cluster1 = cluster_wke.get_group(0)
cluster2 = cluster_wke.get_group(1)
cluster3 = cluster_wke.get_group(2)
cluster4 = cluster_wke.get_group(3)
...
axes[1,2].set_title("Cluster 5")
axes[2,0].set_title("Cluster 6")
plt.suptitle('Hope leisure activities(weekend) by Cluster(1,7)')
plt.show()
